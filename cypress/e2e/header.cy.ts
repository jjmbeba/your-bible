...
describe('Header Component', () => {
  ...
  describe('Accessibility', () => {
    ...
    it('is keyboard navigable', () => {
      // Test that logo is focusable
      cy.get('[data-testid="header-logo"]').focus()
      cy.focused().should('have.attr', 'data-testid', 'header-logo')

      // Test that bible link is focusable
      cy.get('[data-testid="header-nav-link-bible"]').focus()
    ...
    it('mobile menu is keyboard accessible', () => {
      ...
      // Test that mobile menu links are focusable
      cy.get('[data-testid="header-mobile-link-bible"]').focus()
      cy.focused().should('have.attr', 'data-testid', 'header-mobile-link-bible')
    })
  })
